...
This is where I will be sharing my solutions for the daily coding puzzles in the **Advent of Code 2024** challenge.
...
## My Goal 🎯
I am working through the puzzles in **Python**. This repo will serve as my personal progress tracker, and I'll keep updating it regularly.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Lacabrol/Advent_of_Code_2024.git
    ```
