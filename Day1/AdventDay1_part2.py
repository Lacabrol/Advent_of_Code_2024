if (__name__ == '__main__'):
    ...
    with open("input1.txt", "r") as f:
        ...
        final_sum = 0
        # Calculate the sum of products of elements in left_column and their counts in right_column
        for i in range(len(left_column)): final_sum += left_column[i] * right_column.count(left_column[i])
        print(final_sum)